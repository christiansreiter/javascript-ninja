(function() {
    ...
    */
    ...
    console.log(text.replace(/(Manuel Marques de Sousa)/, 'André Christians Reiter'));
    ...
    */
    ...
    console.log(text.replace(/(O Centauro de Luvas)/ig, function(x) {
    ...
    */
    ...
    var nomeDoMes = 'março';
    console.log('O mês de ' + nomeDoMes + ' é representado pelo número ' + getMonthNumber(nomeDoMes) + '.');
    nomeDoMes = 'setembro';
    console.log('O mês de ' + nomeDoMes + ' é representado pelo número ' + getMonthNumber(nomeDoMes) + '.');
    nomeDoMes = 'dezembro';
    console.log('O mês de ' + nomeDoMes + ' é representado pelo número ' + getMonthNumber(nomeDoMes) + '.');
    ...
    */
    ...
    var regexDate = /([0-9]{2}) de (junho|julho) de ([0-9]{4})/g
    ...
    */
    ...
    function replaceDate(dia, mes, ano) {
        var mesEmNumero = getMonthNumber(mes);
        return dia + '/' + mesEmNumero + '/' + ano;
    }

   console.log( text.replace(regexDate, function(total, dia, mes, ano) {
