(function(){
    ...
    */
    ...
    function hasClass(markupp, cssClass) {
        var regex = new RegExp( '="' + cssClass + '"')
        
        return regex.test(markupp) + ' para a classe ' + cssClass
    }
    var classes = ['container', 'text',' date', 'excerpt' , 'main',];
    classes.forEach(function(classesClass) {
        console.log(hasClass(markup, classesClass));
    });
