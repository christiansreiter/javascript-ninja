(function(win, doc)  {
    ...
    */
    ...
    `$message`.
    */
    var $message = doc.querySelector('div textarea');
    // console.log($message);
    ...
    chamada `$button`.
    */
    var $button = doc.querySelector('div button[type="submit"]');
    // console.log($button);
    ...
    */
    ...
    $button.addEventListener('click', function(event) {
        ...
        if($inputUsername.value === ''|| $inputUsername.value === 'Desconhecido') {
            ...
            var confirm = win.confirm('Tem certeza que deseja enviar o formulario?')
            if(confirm) {
                return win.alert('Enviado com sucesso!')
            } else {
                return win.alert('Nao enviado.')
            }
        }
    });
    */
