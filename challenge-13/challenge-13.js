(function() {
    ...
    */
    ...
    console.log([2,5,7,2,6,3,'shahsdah'].toString());
    ...
    */
    ...
    var result = function(aarr) {
       if( aarr.every(function(item, index, arr) {
    ...
    */
    ...
    var ceara = function(arrTest) {
        if(arrTest.some(function(item) {
            return item === 'Ceará';
        })) {
