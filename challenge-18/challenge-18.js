(function() {
    ...
    */
    ...
    console.log(clearCPF("049-214 3421-1"));
    console.log(clearCPF("210.458.522-05"));
    console.log(clearCPF("735 500 794 - 22"));
    console.log(clearCPF( "101.123-131x32"));
    ...
    */
    ...
    console.log('04921434211'.replace(regex, function(reg, first3, second3, third3, andThow) {
        return first3 + '.' + second3 + '.' + third3 + '-' + andThow;
    }));

    console.log('10112313132'.replace(regex, function(reg, first3, second3, third3, andThow) {
        return first3 + '.' + second3 + '.' + third3 + '-' + andThow;
    }));

    console.log('21045852205'.replace(regex, function(reg, first3, second3, third3, andThow) {
        return first3 + '.' + second3 + '.' + third3 + '-' + andThow;
    }));
