...
números do array criado acima. Mostre esse novo array no console. */
    ...
    */
    ...
    if(numberObjects.some( function(item) {
    ...
    console.log('Ele não encontra por que cada objeto no JavaScript é unico, logo o objeto mesmo com o valor igual não é igual')
    ...
    */
    ...
    if(numberObjects.some( function(item) {return item === { number: 2 };})) {
        console.log("Existe um objeto { number: 2 } em numberObjects!");
    } else {
        console.log("Não existe um objeto { number: 2 } em numberObjects :(");
    }
